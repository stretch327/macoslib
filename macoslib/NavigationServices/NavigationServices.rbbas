...
Protected Module NavigationServices
	...
	#tag Structure, Name = NavCBRec, Flags = &h21
		version as UInt16
		  context as Ptr
		  window as Ptr
	...
	#tag Structure, Name = NavEventData, Flags = &h21
		eventDataParms as NavEventDataInfo
		itemHit as Int16
	#tag EndStructure

	#tag Structure, Name = NavEventDataInfo, Flags = &h21
		param as Ptr
	#tag EndStructure

	#tag Structure, Name = NavReplyRecord, Flags = &h21
		version as UInt16
